...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div class="notification-container">
        <div class="notification">
            ...
            <div style="padding-top: 10px; color: #000; font-size: 20px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase;">HADIAH KAMU SEDANG DI PROSES ... </div>
        </div>
    </div>
    <div class="gallery-container">
        <div class="cont">
            <div id="zone" class="gallery">
				...
				<div style="color: #fed33f; font-size: 20px; font-weight: bold; font-family: Teko; text-align: left; text-transform: uppercase;">
				Hallo survivor 
				<br>
				<br>
				Terima kasih karna kamu telah bergabung di event ini
				<br>
				<br>
				AKUN KAMU SAAT INI SEDANG DIPROSES UNTUK MENERIMA HADIAH YANG SEBELUMNYA KAMU PUTAR
				<br>
				<br>
				HARAP TUNGGU DALAM WAKTU 24 JAM
				</div>
				
				<div style="background: #fed33f; width: 45%; height: auto; margin-top: 20px; margin-left: auto; margin-right: auto; padding: 9px; color: #000; font-size: 25px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase; border: 2px solid #000; outline: none; display: block;" onclick="location.href='https://ff.garena.com/';">
				Log out
				</div>
    ...
    <div class="div-bot" style="color:white;padding-top: 10px;padding-bottom: 1px;">
        <center>
		<p>
                <img src="http://freefiremobile-a.akamaihd.net/ffwebsite/images/logo_small_foot.png" style="padding-top: 10px;height:75px;width: 70px;">
				<div style="font-family: Teko;">Copyright © Garena International</div>
		</p>
        </center>
    </div>
